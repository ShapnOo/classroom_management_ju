...
### Full UI / Feature Outline

For this project, the UI is structured as **one platform with three role-based portals**:
...
The key differentiator throughout the UI is **Course Progress & Continuity** — not just storing files.
